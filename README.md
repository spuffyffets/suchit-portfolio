...
# [Built Portfolio With GitHub ](https://github.com/spuffyffets)
...
## View live preview [here](https://suchit-portfolio.netlify.app/).
...
```bash
git clone https://github.com/<YOUR GITHUB USERNAME>/suchit-portfolio.git
...
### Then, Customize data in the `utils/data` [folder](https://github.com/spuffyffets/suchit-portfolio/tree/master/utils/data).
...
export const personalData = {
  ...
  linkedIn: 'www.linkedin.com/in/suchitchaudhari/',
